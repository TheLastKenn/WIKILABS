...
// Modal de imágenes para math.html

document.addEventListener('DOMContentLoaded', function () {
    const modal = document.getElementById('img-modal-math');
    const modalImg = document.getElementById('img-modal-content');
    const closeBtn = document.getElementById('img-modal-close');

    // Abrir modal al hacer click en cualquier imagen de math-section
    document.querySelectorAll('.math-section img, .math-img-row img').forEach(img => {
    ...
    // Permitir arrastrar la imagen dentro del modal (interacción básica)
    ...
    document.addEventListener('mousemove', function(e) {
        ...
        modal.scrollLeft = scrollLeft - (e.pageX - startX);
        modal.scrollTop = scrollTop - (e.pageY - startY);
    });
