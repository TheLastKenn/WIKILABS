window.addEventListener('DOMContentLoaded', () => {
    ...
    function updateStreakOnVisit(){
        ...
        // Racha por curso (ciencia)
        const keyLast = 'wikilabs_course_last_active_date_ciencia';
        const keyStreak = 'wikilabs_course_streak_ciencia';
    ...
    window.addEventListener('beforeunload', () => {
        ...
        if(elapsed > 0){
            ...
            stats.ciencia = (Number(stats.ciencia)||0) + elapsed;
